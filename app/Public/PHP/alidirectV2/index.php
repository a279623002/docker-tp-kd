...
<link rel="stylesheet" type="text/css" href="../../../Public/PHP/alidirectV2/images/combined.css" charset="utf8">
<LINK rel="stylesheet" type="text/css" href="../../../Public/PHP/alidirectV2/images/thickboxpay.css" charset="utf8"> 
<script type="text/javascript" src="../../../Public/PHP/alidirectV2/images/jquery-1.8.3.js"></script>
<SCRIPT type="text/javascript" src="../../../Public/PHP/alidirectV2/images/thickbox.js"></SCRIPT> 
<script type="text/javascript" src="../../../Public/PHP/alidirectV2/images/JScript.js"></script>
<title>支付宝付款</title>
<script>
...
<DIV style="WIDTH: 513px; BACKGROUND: url(../../../Public/PHP/alidirectV2/images/tips.jpg); HEIGHT: 600px" class=TipWindow> 
<DIV> 
<UL class="clearfix"> 
...
<div class="content">
                ...
                <div class="order">
                    <div class="order_content detail">
                        <ul class="clearfix">
							<li><span>付款金额：</span><strong>￥<?php echo $payAmount; ?></strong></li>
							<li><span>收款人：</span><strong><?php echo $optEmail; ?></strong></li>
							<li><span>姓名提示：</span><strong>吴*刚</strong></li>
                            <li><span>付款说明：</span><strong><?php echo $title; ?></strong> &nbsp;</li>
                        </ul>
		...
		<div class="contentwrap">
              	...
              	<div class="paypanel" style="display: block;height: 470px;">
                	<div class="content_left">
                     ...
                     <img src="../../../Public/PHP/alidirectV2/images/QR.png" style="margin-top:20px; padding-top:20px;margin-left:20px; padding-left:20px">
                     </div>
				</div>
					

				<div class="paypanel" style="display: none; height: 470px;">
                	<div class="content_left">
			...
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="410" height="410" id="alipay" align="middle">
				<param name="movie" value="../../../Public/PHP/alidirectV2/images/alipay.swf">
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="../../../Public/PHP/alidirectV2/images/alipay.swf" width="410" height="410">
				...
				<!--<![endif]-->
					<a href="http://www.adobe.com/go/getflash">
						<img src="../../../Public/PHP/alidirectV2/images/get_flash_player.gif" alt="获得 Adobe Flash Player">
					</a>
				<!--[if !IE]>-->
				</object>
                     </div>
