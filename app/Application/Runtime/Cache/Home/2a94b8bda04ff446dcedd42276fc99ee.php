...
<head>
  ...
  <title>易网包</title>
  <meta name="keywords" content="易网包" />
  <meta name="description" content="易网包" />
  <link rel="shortcut icon" href="favicon.html" />
  <script src="/Public/Home/js/jquery.min.js"></script>
  <script type="text/javascript" src="/Public/Home/js/widget.js"></script>
  ...
  <script type="text/javascript" src="http://tajs.qq.com/stats?sId=66099359" charset="UTF-8"></script>
  <style>
    .fw-01 {
      width: 100%;
    ...
    .fw-03cen {
      background: url(/Public/Home/images/fwbbzbg.html) no-repeat;
      height: 1310px;
      padding-bottom: 20px
    }
    ...
    .fuwubaozhang {
      background: url("/Public/Home/images/fwbz.png") no-repeat;
      height: 100%;
    }

    .fuwubaozhang ul li .li-iterm {
      width: 350px;
    ...
    .fuwubaozhang ul li:first-child {
      margin-top: 20px;
    }
    ...
    .fuwubaozhang ul li:nth-child(3) {
      margin-top: 30px;
    }

    .fuwubaozhang ul li:nth-child(4) {
      margin-top: 30px;
    }

    .fuwubaozhang ul li:nth-child(5) {
      margin-top: 30px;
    }

    .fuwubaozhang ul li:nth-child(6) {
      margin-top: 30px;
    }

    .fuwubaozhang ul li:nth-child(7) {
      margin-top: 30px;
    }

    .fuwubaozhang ul li:nth-child(8) {
      margin-top: 30px;
    }



    .fuwubaozhang ul li .li-iterm-left {
      margin-left: 120px;
    }

    .fuwubaozhang ul li .li-iterm-right {
      margin-right: 80px;
      text-align: right;
    }
    ...
    .about {
      ...
      background-image: url('/Public/Home/images/about_bg.png');
    ...
    .about .about_r {
      ...
      margin-top: 2%;
      padding-top: 1%;
      background: url('/Public/Home/images/about_title.png') top left no-repeat;
    }
...
<li class="notification-dropdown">
<a href="<?php echo U('Home/Seller/accountlog');?>" title="消费记录">余额：<?php echo ($seller["money"]); ?> 元</a>
</li>
<li class="notification-dropdown">
<a href="<?php echo U('Home/Order/pay');?>">充值 </a>
</li>
<li class="notification-dropdown">
<a href="<?php echo U('Home/Seller/logout');?>" role="button" title="退出">
...
<span class="admin-fullText">开启全屏</span>
  ...
  <!-- end navbar -->
  <!--flash-->
  <div id="indexBanner" class="index-banner pr">
    <div class="bd" style=" position: relative;">
      <img src="/Public/Home/images/indexBanner.png" style="width: 100%;" alt="">
      <a href="<?php echo U('Home/Express/newadd');?>" style="position: absolute; top: 63%; left: 20%;">
        <img src="/Public/Home/images/order.png" alt="">
      </a>
    </div>
    <div class="hd">
      <ul class="banner-bar">
  ...
  <div class="about">
    <div class="about_r">
      <p>易网包全网唯一一家专业提供真实发货快递单的网站。我们只和业内知名快递公司合作，每张快递单都真实打印发往全国， 每个快递包裹都可以自定义包裹重量，减少降权几率。我们杜绝假单、过期单和重复使用单！降权后可提供申诉使用的快递单和快递公司内网截图证明，
        提高您商品降权申诉成功几率！
      </p>
      <a href="<?php echo U('Home/Seller/register');?>">免费注册</a>
      <a href="<?php echo U('Home/Express/didan');?>">查看底单信息</a>
    </div>
  </div>
  <div class="index-case-box">
    <div class="wrap index-plat" style="margin-bottom: 150px;">
      <div class="fw-01">
        <img src="/Public/Home/images/advantage.png" />
      </div>
      <div class="fuwubaozhang">
        <div style="padding-top: 70px;">
          <ul class="clearfix">
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">
                <p>与知名快递公司合作，拒绝和已被某宝后台加入黑名单的快递合作</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>多为不知名的小快递，早已被某宝后台加入炒作黑名单，你是找死吗？</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>保存底单2个月，随时可申请电子档案，增加申诉成功机会</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>收件人姓名和快递底单不符，多为重复盗用快递单！</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>全国主要城市，专人打印快递面单，真实发货！杜绝假单、过期单，重复单</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>都是系统虚假发货，或者重复被用过的快递单，一用就被降权。</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>全国独家！40kg内支持自定义包裹重量，中转站显示重量。提高真实性</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>都没发货哪里有重量？中转站去哪里给你称重</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>支持发件网店代签收，有效防止拒签现象</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>回传单多为PS信息，平台根本不会审核通过，物流信息保存不足7天</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>提供快递公司内网截图证明，增加申诉成功机会</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">
                <p>无法提供，快递公司内网有时根本查不到</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>快递公司可出具发货证明，增加申诉成功机会</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>无法提供发货证明，多为系统虚拟假包裹</p>
              </div>
            </li>
            <li class="clearfix">
              <div class="pull-left li-iterm li-iterm-left">

                <p>可以拔打快递官网热线查询包裹信息</p>
              </div>
              <div class="pull-right li-iterm li-iterm-right">

                <p>拔打快递公司客服热线查不到快递信息 容易被抽查降权
                </p>
              </div>
            </li>
          </ul>
    ...
    <footer class="am-footer am-footer-default am-topbar-fixed-bottom" style="background: #2e2e2e;">
      <div class="am-footer-miscs " style="color: #FFF;">
        <p>
          ...
          <?php if(is_array($flink)): foreach($flink as $k=>$vo): ?><a href="<?php echo ($vo["link"]); ?>" class="" style="color: #FFF;">
              <!-- <img src="./Uploads/flink/<?php echo ($vo['pic']); ?>" style="width: 20px; height: 20px;" alt="" srcset=""> -->
